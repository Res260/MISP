			...
			<table style="background-color:white;">
				...
				?>
					<tr id="row_<?php echo $field; ?>" class="hidden filterTableRow">
						...
						<td id="delete_<?php echo $field;?>" style="border:1px solid #cccccc;border-left:0px;"><span class="glyphicon glyphicon-trash" title="<?php echo __('Remove filter');?>" role="button" tabindex="0" aria-label="<?php echo __('Remove filter');?>" onClick="indexFilterClearRow('<?php echo $field;?>');"></span></td>
					</tr>
				<?php
					endforeach;
				?>
