					...
					<div class="templateTableTDActions templateTableArea">
						...
						<div class="">
							...
							<?php
									echo $this->Form->end();
							?>
									<span class="glyphicon glyphicon-edit useCursorPointer" title="<?php echo __('Edit template element');?>" role="button" tabindex="0" aria-label="<?php echo __('Edit template element');?>" onClick="editTemplateElement('file' ,'<?php echo h($element_id); ?>');"></span>
							<?php
								} else {
									echo '&nbsp;';
								}
