...
<tr id = "Object_<?php echo $object['id']; ?>_tr" class="<?php echo $tr_class; ?>" tabindex="0">
  ...
  <td class="short action-links">
    ...
    ?>
        <a href="<?php echo $baseurl;?>/objects/edit/<?php echo $object['id']; ?>" title="Edit" class="glyphicon glyphicon-edit glyphicon glyphicon-white useCursorPointer"></a>
        <span class="glyphicon glyphicon-trash glyphicon glyphicon-white useCursorPointer" title="<?php echo __('Permanently delete object');?>" role="button" tabindex="0" aria-label="<?php echo __('Permanently delete object');?>" onClick="deleteObject('objects', 'delete', '<?php echo h($object['id']); ?>', '<?php echo h($event['Event']['id']); ?>');"></span>
    <?php
      elseif ($mayModify):
    ?>
        <span class="glyphicon glyphicon-trash glyphicon glyphicon-white useCursorPointer" title="<?php echo __('Soft delete object');?>" role="button" tabindex="0" aria-label="<?php echo __('Soft delete attribute');?>" onClick="deleteObject('objects', 'delete', '<?php echo h($object['id']) . '/true'; ?>', '<?php echo h($event['Event']['id']); ?>');"></span>
    <?php
      endif;
    ?>
  </td>
