			...
			<tr>
				...
				<?php
					...
					<tr>
						...
						<td class="short">
							<?php
								echo $this->Form->postLink('', array('controller' => 'servers', 'action' => 'deleteFile' , $k , $f['filename']), array('class' => 'glyphicon glyphicon-trash', 'title' => __('Delete')), __('Are you sure you want to delete %s?', $f['filename']));
							?>
						</td>
					</tr>
				<?php
