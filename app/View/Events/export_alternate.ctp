<div class="event index">
	...
	<div class="row bottom-buffer">
		...
		<div class="col-md-9"><?php echo __('Click this to download all events and attributes that you have access to <small>(except file attachments)</small> in a custom XML format.');?>
		</div>
	</div>
	<div class="row bottom-buffer">
		<div class="col-md-3">
		...
		<div class="col-md-9"><?php echo __('Click this to download all attributes that are indicators and that you have access to <small>(except file attachments)</small> in CSV format.');?>
		</div>
	</div>
		<div class="row bottom-buffer">
		<div class="col-md-3">
		...
		<div class="col-md-9"><?php echo __('Click this to download all attributes that you have access to <small>(except file attachments)</small> in CSV format.');?>
		</div>
	</div>
	<div class="row bottom-buffer">
		<div class="col-md-3">
		...
		<div class="col-md-9"><?php echo __('Click these to download all network related attributes that you
	...
	<div class="row bottom-buffer">
		...
		<div class="col-md-9"><?php echo __('Click this to download an RPZ Zone file generated from all ip-src/ip-dst, hostname, domain attributes. This can be useful for DNS level firewalling. Only published events and attributes marked as IDS Signature are exported.');?>
		</div>
	</div>
	<div class="row bottom-buffer">
		<div class="col-md-3">
		...
		<div class="col-md-9"><?php echo __('Click on one of these two buttons to download all MD5 or SHA1
