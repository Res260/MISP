...
?>
		<tr>
			...
			<?php
				...
				if ($item['Job']['failed']):
			?>
				<div class="glyphicon glyphicon-search useCursorPointer queryPopover" title="<?php echo __('View stacktrace');?>" role="button" tabindex="0" aria-label="<?php echo __('View stacktrace');?>" data-url="/jobs/getError" data-id="<?php echo h($item['Job']['process_id']); ?>"></div>
			<?php
				endif;
			?>
			</td>
