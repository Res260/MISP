					...
					<div class="templateTableRow" style="width:800px;">
						...
						<div style="padding:6px;">
							...
							<?php
								...
								if ($isSiteAdmin):
							?>
									<br /><a href="<?php echo $baseurl; ?>/news/edit/<?php echo h($newsItem['News']['id']);?>" class="glyphicon glyphicon-edit" title="<?php echo __('Edit news message');?>"></a>
							<?php
									echo $this->Form->postLink('', array('action' => 'delete', $newsItem['News']['id']), array('class' => 'glyphicon glyphicon-trash', 'title' => 'Delete'), __('Are you sure you want to delete news item # %s?', $newsItem['News']['id']));
								endif;
							?>
						</div>
					</div>
